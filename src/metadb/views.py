...
#                'create_api_url': app_prfx+'fullsetting-detail'},
        ...
        tabs = [
            ...
            { 'name': "conveyor", 'label': _("Conveyors"), 'dialog_id': 'id_conveyor_dialog',
            ...
            { 'name': "setting", 'label': _("Processors settings"),
              'list_url': 'metadb:fullsetting-list', 'detail_url': 'metadb:fullsetting-detail' },
            { 'name': "processor", 'label': _("Processors"),
